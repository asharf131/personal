                    ...
                    <form method="POST" action="{{ route('projects.store') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 md:col-span-2" x-data="{ imagePreview: '' }">
                                <x-input-label for="image" :value="__('Project Image')" class="font-bold text-gray-700" />
                                
                                <!-- Preview Area -->
                                <div x-show="imagePreview" class="mt-4 mb-4 relative group w-full max-w-sm mx-auto">
                                    <img :src="imagePreview" class="w-full h-48 object-cover rounded-xl shadow-lg border-2 border-indigo-100">
                                    <button type="button" @click="imagePreview = ''; $refs.imageInput.value = ''" 
                                    ...
                                    <div class="space-y-1 text-center">
                                        ...
                                        <div class="flex text-sm text-gray-600 justify-center">
                                            <label for="image" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none">
                                                ...
                                                <input id="image" name="image" type="file" class="sr-only" required x-ref="imageInput"
