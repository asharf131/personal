...
<html lang="en">
    <head>
        ...
        <meta name="description" content="{{ $settings['about_summary'] ?? '' }}" />
        <meta name="author" content="{{ $settings['site_name'] ?? '' }}" />
      <title>@yield('title', $settings['site_name'] ?? env('APP_NAME'))</title>
        <!-- Favicon-->
        ...
        <main class="flex-shrink-0">
            <!-- Navigation-->
                ...
                <div class="container px-5">
                    <a class="navbar-brand" href="{{ route('personal.index') }}"><span class="fw-bolder text-primary">{{ $settings['site_name'] ?? 'Portfolio' }}</span></a>
        ...
        <footer class="bg-white py-4 mt-auto">
            <div class="container px-5">
                <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                    <div class="col-auto"><div class="small m-0">Copyright &copy; {{ $settings['site_name'] ?? 'Portfolio' }} {{ date('Y') }}</div></div>
                    <div class="col-auto">
